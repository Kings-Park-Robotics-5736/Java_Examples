...
public class Robot extends TimedRobot implements PIDOutput {
  ...
  //private KPDrive kpDrive = new KPDrive(left, right, leftEncoderForward, leftEncoderBackward, rightEncoderForward, rightEncoderBackward, shiftForward, shiftBackward);
