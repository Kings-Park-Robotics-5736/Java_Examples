...
public class Robot extends TimedRobot {
  ...
  void gryo_driveStraight(double speed)
  {
    double Kp = 0.03;
    double angle = gyro.getAngle();   // get current heading
    drive.tankDrive(1.0, -angle*Kp);  // drive towards heading 0
    Timer.delay(0.004);
  }
  ...
  public void robotInit() {
    ...
    // set gyro ranges
//    gyropid.setOutputRange(-180, 180);
  ...
  public void robotPeriodic() {
    ...
    SmartDashboard.putString("DB/String 2", "" + gyro.getAngle());
  ...
  public void teleopPeriodic() {
    ...
    {
      gryo_driveStraight(0.5);  // range 0-1
    }
